...
SELECT CAST(EmployeeID AS Varchar)+ '-' + FirstName, StartDate from employee_info;
SELECT CONVERT(Varchar, EmployeeID)+ '-' + FirstName, StartDate from employee_info;
...
/*
	...
	* In this, there are not BEGIN and END Blocks.
