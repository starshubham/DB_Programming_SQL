...
--Insert
INSERT INTO employeeTrans(emp_id,dept,Age,salary) Values(106,2,45,30000)
--Update
...
SET IMPLICIT_TRANSACTIONS ON
--Insert
INSERT INTO employeeTrans(emp_id,dept,Age,salary) Values(108,2,35,30000);
--Update
UPDATE employeeTrans SET Salary=40000 Where emp_id=101;
--Delete
DELETE FROM employeeTrans Where emp_id=107;
...
BEGIN TRANSACTION
--Insert
INSERT INTO employeeTrans(emp_id,dept,Age,salary) Values(108,3,33,50000);
--Update
UPDATE employeeTrans SET Salary=30000 Where emp_id=101;
--Delete
DELETE FROM employeeTrans Where emp_id=107;
...
BEGIN TRANSACTION
	INSERT Into employeeTrans(emp_id,dept,Age,salary) Values (110,2,60,60000)
